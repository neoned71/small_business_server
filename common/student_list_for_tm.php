<div class="w3-black w3-row w3-card" style="margin-right:50px;margin-bottom: 10px;">
	...
	<a class=" w3-col w3-padding w3-black" href='<?php echo "../../test_series/result_page.php?test_id=".$test_id."&candidate_id=".$t->candidate->id; ?>' style="margin:0px;width:20%;height:100%;">
