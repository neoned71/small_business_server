<div class="w3-black w3-row w3-card" style="margin-right:50px;margin-bottom: 10px;">
	...
	<a class=" w3-col w3-padding w3-black" href='<?php echo $link."/common/test_paper_for_printing.php?test_id=".$t->test_id; ?>' style="margin:0px;width:10%;height:100%;">
 		<div class="w3-text-white w3-hover-text-teal w3-padding" >
			<h5>Test Paper</h5>
		</div>
	</a>
	<a class=" w3-col w3-padding w3-black" href='<?php echo $link."/common/test_for_printing_answers.php?test_id=".$t->test_id; ?>' style="margin:0px;width:10%;height:100%;">
 		<div class="w3-text-white w3-hover-text-teal w3-padding" >
			<h5>Test Answers</h5>
		</div>
	</a>
	<a class=" w3-col w3-padding w3-black" href='<?php echo $link."/common/test_for_printing_solutions.php?test_id=".$t->test_id; ?>' style="margin:0px;width:10%;height:100%;">
 		<div class="w3-text-white w3-hover-text-teal w3-padding" >
			<h5>Test Solutions</h5>
		</div>
	</a>
</div>