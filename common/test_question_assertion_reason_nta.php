<div class="question w3-border">
	...
	<div class=" w3-padding">
			...
			<h2 class="w3-text-teal w3-center w3-round">Assertion-Reason</h2>
			...
			for(;$i<4;$i++)
			{
				...
				echo '<input id="'.$question_number.'-'.$option_number.'" class="w3-margin" type="radio" name="ans'.$question_number.'" onclick="toggleAssertionReasonOption(this.id)" '.$marked.'>'.$a[$i].'<br><hr>';
			}
			?>
		</div>
		</div>
