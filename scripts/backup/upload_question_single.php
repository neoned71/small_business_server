...
$source=handle_escaping($dbc,$_POST['source']);
...
$id=insert_question_single($dbc,$subject_id, $topic_id, $difficulty,$question,json_encode($options),$correct_ans,addslashes(json_encode($solution)),$image_name,$marking,$source);
