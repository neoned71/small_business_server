...
$comprehension_id=handle_escaping($dbc,$_POST['comprehension_id']);
...
$id=insert_question_comprehension($dbc,$subject_id, $topic_id, $difficulty,$question,json_encode($options),$correct_ans,addslashes(json_encode($solution)),$image_name,$comprehension_id,$marking);
