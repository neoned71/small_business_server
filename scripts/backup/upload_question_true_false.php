...
$id=insert_question_true_false($dbc,$subject_id, $topic_id, $difficulty,$question,json_encode($options),$correct_ans,addslashes(json_encode($solution)),$image_name,$marking);
